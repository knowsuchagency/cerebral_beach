...
def generate_flashcards(request, raw_data: str, num_flashcards: int = 10):
    @llm
    def generate(raw_data: str, num_flashcards: int = num_flashcards) -> FlashCards:
        """
        ...
        Generate {num_flashcards} flashcards based on the analyzed data. Each flashcard should consist of a question (front of the card) and an answer (back of the card). Ensure that the questions are clear and concise, and the answers are accurate and informative.
    ...
    return generate(raw_data, num_flashcards)
